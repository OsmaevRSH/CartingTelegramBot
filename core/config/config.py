...
TELEGRAM_LOGIN_ORIGIN = os.getenv("TELEGRAM_LOGIN_ORIGIN", "")
TELEGRAM_LOGIN_CLIENT_ID = os.getenv("TELEGRAM_LOGIN_CLIENT_ID", "")
TELEGRAM_LOGIN_JWKS_URL = os.getenv(
    "TELEGRAM_LOGIN_JWKS_URL", "https://oauth.telegram.org/.well-known/jwks.json"
)
TELEGRAM_LOGIN_JWKS_TIMEOUT_SECONDS = float(
    os.getenv("TELEGRAM_LOGIN_JWKS_TIMEOUT_SECONDS", "2")
)
